...
/// <summary>
/// Агрегированный health ValkeyWorker (arch/21 §7): секции etcd-reachable,
...
/// </summary>
public sealed class ValkeyWorkerHealth(
    ...
    TimeProvider clock) : IHealthCheck
{
    public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken ct = default)
    {
        ...
        {
            // Catch-all (t09, arch/21 §7): чек ВСЕГДА отдаёт структуру — неожиданный
    ...
    private async Task<HealthCheckResult> CheckCoreAsync(CancellationToken ct)
    {
        ...
        return degraded.Count == 0
            ? HealthCheckResult.Healthy("ValkeyWorker жив", data)
