...
// etcd-клиент против DNS-флейпа Docker embedded DNS (t09; arch/21 §7):
...
public class EtcdConnectCallbackTests
{
    ...
    {
        // Arrange: IP-литерал — прямой вызов внутренней механики ветки
        // IPAddress.TryParse (публичного конструктора SocketsHttpConnectionContext
        // в TFM нет); порт закрыт (refused).
        // Act
