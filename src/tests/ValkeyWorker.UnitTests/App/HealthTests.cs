...
public class HealthTests
{
    ...
    private static ServiceProbes Probes(IEtcdGateway etcd)
        => new(etcd, Options, new ValkeyWorker.Docker.Engine.DockerEngineFactory());
    ...
    private sealed class ThrowingFactory : ValkeyWorker.Docker.Engine.DockerEngineFactory
    {
        public override ValkeyWorker.Docker.Engine.IDockerEngine Create(string endpoint, string? hostAlias = null)
