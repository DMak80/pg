    ...
    public async Task ActiveAsync_BackoffWindow_SkipsKafkaSteps()
    {
        ...
        var processes = new KafkaClusterProcesses(
            new ProvisioningProcess(fixture.Gateway, ep, fixture.Driver, claims, journal,
                ...
                fixture.Certificates, snapshot: null),
            ...
            new NodeSupervisor(fixture.Gateway, ep, fixture.Driver, claims, journal,
                factory, fixture.Options, fixture.Certificates, backoff),
            ...
            new SecurityMigrator(fixture.Gateway, ep, fixture.Driver, claims, journal,
                new ClusterSecretEnsurer(fixture.Gateway, ep), factory,
                new ClusterConfigConverger(factory), fixture.Options, fixture.Certificates),
            backoff);
