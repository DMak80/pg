...
**Действие (шаги):**
- [ ] 1. Создать трек-файл по шаблону `arch/roadmap/pgworker.md` (заголовок, «Задачи») с шестью пунктами t01–t06 (тексты — из spec §8, сокращённо: суть + контекст-ссылки на arch/15/16).
- [ ] 2. В `arch/roadmap/README.md` добавить строку трека в таблицу: `kafkaworker.md | сервис KafkaWorker: топики, ребалансировка, безопасность, метрики, дискавери-библиотека`.
