...
- [x] **Шаг 1: docker-E2E на свежем Release (обязателен — меняется PgWorker.Provisioning)**
...
- [x] **Шаг 2: зачистка контейнеров/сетей после каждой серии**
...
- [x] **Шаг 3: финальная сверка критериев приёмки (spec §7)**
